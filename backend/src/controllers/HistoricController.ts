...
class HistoricController {
  async create(request: Request, response: Response): Promise<Response> {
    try {
      ...
      const historic = await historicService.create(
  ...
  async getHistoric(request: Request, response: Response): Promise<Response> {
    try {
      ...
      const historic = await historicService.getHistoricByMatNbr(
        parseInt(matriculationNumber)
      );
  ...
  async deleteHistoric(
    ...
    try {
      ...
      const historic = await historicService.deleteHistoric(
        parseInt(matriculationNumber)
      );
