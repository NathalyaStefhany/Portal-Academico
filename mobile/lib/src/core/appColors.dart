...
class AppColors {
  ...
  static final Color gray = Color(0xFF666666);
  static final Color text = Color(0xFF333333);
  static final Color yellow = Color(0xFFDDFF97);
  ...
  static final Color red = Color(0xFFFF5B1A);
}
