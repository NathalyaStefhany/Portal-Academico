...
class _ClassMaterialViewState extends State<ClassMaterialView> {
  ...
  final subjects = ['Todas', 'C213', 'C317', 'C209'];

  String subject = 'Todas';
                    ...
                    TableRow(
                      ...
                      children: [
                        Padding(
                          ...
                          child: Text('Sigla', style: AppTextStyles.bodyBlue16, textAlign: TextAlign.center),
                        ),
                        Text('Título', style: AppTextStyles.bodyBlue16, textAlign: TextAlign.center),
                        Text('', style: AppTextStyles.bodyBlue16, textAlign: TextAlign.center)
                      ]
                    ),
                        ...
                        decoration: BoxDecoration(
                          border: Border(
                            bottom: BorderSide(
                              ...
                              width: 1,
                              style: i != material.length - 1 ? BorderStyle.solid : BorderStyle.none
                            )
                          )
                        ),
                        children: [
